            ...
            <div className="lg:py-4">
              ...
              <div className="mb-6">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <button className="text-[0.4rem] tracking-[1px] text-wine underline underline-offset-2">
                    Size Guide
                  </button>
                </div>
              ...
              <div className="flex gap-3 mb-8">
                ...
                <button
                  ...
                  className="w-14 flex items-center justify-center border border-blue-mid/30 text-blue-mid hover:border-wine hover:text-wine transition-colors"
