...
export function HeroSection() {
  ...
  return (
    <section id="home" className="relative overflow-hidden">
      {/* MOBILE & TABLET LAYOUT - Full bleed editorial hero like Cartier/Celine */}
      <div className="lg:hidden">
        {/* Full-bleed Hero Image with Text Overlay */}
        <div className="relative w-full h-[70vh] min-h-[500px] md:h-[60vh] md:min-h-[550px]">
          ...
          <div
            ...
            style={{
              background: "linear-gradient(108deg, transparent 38%, rgba(255,255,255,0.15) 50%, transparent 62%)",
            }}
          />

          {/* Text Content Overlay - Bottom positioned */}
          <div className="absolute inset-x-0 bottom-0 px-6 pb-10 md:pb-14 md:px-10">
            {/* Eyebrow */}
            <div className="flex items-center gap-3 mb-4 animate-fadeUp">
              <div className="w-5 h-[0.5px] bg-ivory/50" />
              <span className="text-[0.4rem] font-extralight tracking-[4px] uppercase text-ivory/70">
                {t("hero", "eyebrow")}
              </span>
            </div>

            {/* Headline */}
            <h1 className="font-serif italic font-light text-[2rem] md:text-[2.8rem] text-ivory leading-[1.12] mb-4 animate-fadeUp-delay-1">
              {t("hero", "headline1")}
              <br />
              {t("hero", "headline2")}
            </h1>
            ...
            {/* Description */}
            <p className="font-serif font-light text-[0.9rem] md:text-base text-ivory/80 leading-[1.8] max-w-[340px] mb-7 animate-fadeUp-delay-2">
              {t("hero", "subline")}
            </p>

            {/* Buttons */}
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 animate-fadeUp-delay-3">
              <Link
                href="#shop"
                className="text-[0.42rem] font-extralight tracking-[4px] uppercase text-wine-deep bg-ivory border-[0.5px] border-ivory px-8 py-3.5 inline-block hover:bg-ivory/90 transition-all duration-300"
              >
                {t("hero", "exploreCollection")}
              </Link>
              <Link
                href="#about"
                className="text-[0.42rem] font-extralight tracking-[4px] uppercase text-ivory/90 flex items-center gap-2 hover:text-ivory transition-all duration-300"
              >
      ...
      {/* DESKTOP LAYOUT */}
      <div className="hidden lg:block min-h-screen relative pt-[70px]">
        {/* Background */}
        <div
        ...
        <div className="relative z-[2] max-w-[1200px] mx-auto w-full px-6 lg:px-14 min-h-[calc(100vh-70px)] flex items-center">
          <div className="grid grid-cols-2 gap-14 items-center w-full">
            ...
            <div className="text-left">
              {/* Eyebrow */}
              <div className="flex items-center gap-3.5 mb-5 animate-fadeUp">
              ...
              {/* Description */}
              <p className="font-serif font-light text-base text-blue-deep leading-[1.9] max-w-[360px] mb-11 animate-fadeUp-delay-2">
                {t("hero", "subline")}
              </p>

              {/* Buttons */}
              <div className="flex items-center gap-6 animate-fadeUp-delay-3">
                <Link
                  href="#shop"
            ...
            <div className="relative flex items-center justify-center animate-fadeIn">
              ...
              {/* Card */}
              <div className="w-full max-w-[430px] aspect-[3/4] relative overflow-hidden shadow-[0_30px_80px_rgba(90,15,26,0.08)] rounded-sm">
                {/* Shimmer */}
                <div
