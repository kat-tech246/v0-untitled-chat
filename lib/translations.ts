...
export const translations = {
  ...
  ourStory: {
    ...
    body: {
      ...
      ru: [
        "Украшения всегда считались чем-то заработанным. Знаковым моментом. Подарком для той версии себя, которая ещё впереди. Нам всегда казалось это немного грустным.",
